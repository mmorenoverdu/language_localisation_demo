...
This demo is should work both for **offline (local)** as well as **online (Pavlovia)** experiments. However, online localisation may require different handling and JavaScript-compatible code, and future updates may require adjustments.
